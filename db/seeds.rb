...
sleep 1
users[1].favours.find_or_create_by(titulo: "Ayuda 1", descripcion:" Descripcion 1", ciudad: "Bariloche", provincia: "Rio Negro")
sleep 1
users[2].favours.find_or_create_by(titulo: "Ayuda 2", descripcion:" Descripcion 2", ciudad: "Buenos Aires", provincia: "Buenos Aires")
sleep 1
users[3].favours.find_or_create_by(titulo: "Ayuda 3", descripcion:" Descripcion 3", ciudad: "Olmos", provincia: "Buenos Aires", image_url: "http://gdurl.com/avof" )
sleep 1
users[0].favours.find_or_create_by(titulo: "Busco acompañante de viaje", descripcion:"Soy camionero y busco una persona que me acompañe e mi viaje hasta Rawson porque sufro problemas de sueño.\n Saldriamos el primer fin de semana de octubre y retornariamos el fin de semana siguiente. \n Condición fundamental: debe cebar buenos mates.", ciudad: "Rosario", provincia: "Rosario")
